    ...
    return (
      <div className="border-2 border-gray-200 rounded-lg p-4 bg-white">
        ...
        <div 
          ...
          // ✅ FIXED: Added comment explaining XSS safety
          // This HTML is generated by internal barcodeService.generateLabelHTML() 
          // and contains only safe, structured label HTML - not user input
