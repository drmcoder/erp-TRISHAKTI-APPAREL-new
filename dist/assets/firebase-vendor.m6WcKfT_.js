 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j_{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=Kt(e)}set(e,t,r){this._verifyNotCommitted();const s=_t(e,this._firestore),o=Xs(s.converter,t,r),a=Hs(this._dataReader,"WriteBatch.set",s._key,o,s.converter!==null,r);return this._mutations.push(a.toMutation(s._key,oe.none())),this}update(e,t,r,...s){this._verifyNotCommitted();const o=_t(e,this._firestore);let a;return a=typeof(t=ne(t))=="string"||t instanceof Vn?zo(this._dataReader,"WriteBatch.update",o._key,t,r,s):$o(this._dataReader,"WriteBatch.update",o._key,t),this._mutations.push(a.toMutation(o._key,oe.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=_t(e,this._firestore);return this._mutations=this._mutations.concat(new Er(t._key,oe.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new V(S.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function _t(n,e){if((n=ne(n)).firestore!==e)throw new V(S.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BE=300,qE=qu("authIdTokenMaxAge")||BE;let Ou=null;const jE=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>qE)return;const s=t?.token;Ou!==s&&(Ou=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function VT(n=Wu()){const e=co(n,"auth");if(e.isInitialized())return e.getImmediate();const t=wy(n,{popupRedirectResolver:LE,persistence:[Wy,My,Zh]}),r=qu("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const o=new URL(r,location.origin);if(location.origin===o.origin){const a=jE(o.toString());Dy(t,a,()=>a(t.currentUser)),ky(t,u=>a(u))}}const s=Uu("auth");return s&&Ay(t,`http://${s}`),t}function $E(){return document.getElementsByTagName("head")?.[0]??document}yy({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const o=ze("internal-error");o.customData=s,t(o)},r.type="text/javascript",r.charset="UTF-8",$E().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});UE("Browser");export{_T as $,Yd as A,et as B,Bt as C,Zd as D,ef as E,vn as F,ju as G,$u as H,An as I,pr as J,Bf as K,oo as L,ot as M,sT as N,df as O,hf as P,HE as Q,af as R,ZE as S,rT as T,wp as U,aT as V,VT as W,oT as X,k_ as Y,Y as Z,dn as _,jd as a,mT as a0,yT as a1,ET as a2,lT as a3,dT as a4,fT as a5,gT as a6,hT as a7,PT as a8,IT as a9,wT as aa,vT as ab,bT as ac,CT as ad,TT as ae,ST as af,cT as ag,uT as ah,AT as ai,RT as aj,pT as ak,XE as b,JE as c,tT as d,xu as e,$d as f,eT as g,Ue as h,j as i,uc as j,QE as k,KE as l,YE as m,gf as n,rf as o,cf as p,mr as q,Et as r,WE as s,ne as t,zE as u,nT as v,Hd as w,GE as x,Wu as y,co as z};
